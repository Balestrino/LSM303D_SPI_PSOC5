...
#define BS_IOPORT_0_VAL ((const uint8 CYFAR *)0x48001000u)

/* IOPORT_3 Address: CYDEV_PRTDSI_PRT3_BASE Size (bytes): 7 */
#define BS_IOPORT_3_VAL ((const uint8 CYFAR *)0x48001008u)
...
static void cfg_dma_init(void)
{
	...
	static const struct td_t CYCODE CFG_TD_LIST0[] DMAINITSEC = {
		...
		{ 896u, 0x10u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P6_U0_BASE) },	/* TD 15 */
		{ 384u, 0x11u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P3_U0_BASE) },	/* TD 16 */
		{ 1024u, 0x12u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P4_U0_BASE) },	/* TD 17 */
		...
		{ 384u, 0x17u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI7_BASE) },	/* TD 22 */
		{ 256u, 0x18u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI9_BASE) },	/* TD 23 */
		{ 512u, 0xFFu, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI12_BASE) },	/* TD 24 */
		{ 32u, 0x1Au, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UWRK_UWRK8_B0_BASE + 0x00000070u) },	/* TD 25 */
		{ 32u, 0xFFu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UWRK_UWRK8_B1_BASE + 0x00000070u) },	/* TD 26 */
		{ 128u, 0x1Cu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P0_U0_BASE) },	/* TD 27 */
		{ 128u, 0x1Du, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P0_U1_BASE) },	/* TD 28 */
		...
		{ 128u, 0x25u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI5_BASE + 0x00000080u) },	/* TD 36 */
		{ 128u, 0x26u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI4_BASE) },	/* TD 37 */
		{ 128u, 0x27u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI4_BASE + 0x00000080u) },	/* TD 38 */
		...
		{ 128u, 0x2Au, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P3_ROUTE_BASE + 0x00000080u) },	/* TD 41 */
		...
		{ 128u, 0x2Du, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P2_ROUTE_BASE) },	/* TD 44 */
		{ 128u, 0x2Eu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P2_ROUTE_BASE + 0x00000080u) },	/* TD 45 */
		{ 128u, 0x2Fu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P1_ROUTE_BASE) },	/* TD 46 */
		{ 128u, 0x30u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P1_ROUTE_BASE + 0x00000080u) },	/* TD 47 */
		{ 128u, 0x31u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P7_ROUTE_BASE + 0x00000080u) },	/* TD 48 */
		{ 128u, 0x32u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P0_ROUTE_BASE) },	/* TD 49 */
		{ 128u, 0x33u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P0_ROUTE_BASE + 0x00000080u) },	/* TD 50 */
		{ 128u, 0x34u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI8_BASE + 0x00000080u) },	/* TD 51 */
		{ 128u, 0x35u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI3_BASE) },	/* TD 52 */
		...
		{ 16u, 0x3Bu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYREG_BCTL1_MDCLK_EN) },	/* TD 58 */
		{ 16u, 0xFFu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYREG_BCTL0_MDCLK_EN) },	/* TD 59 */
	};
	...
	static const void * const CFG_TD_ADDR0[] = {
		...
		(const void *)(BS_DSI0_4_HV_ROUTING_VAL),	/* TD 36 */
		(const void *)(BS_DSISWITCH_0_5_VAL),	/* TD 37 */
		(const void *)(BS_DSI0_5_HV_ROUTING_VAL),	/* TD 38 */
		(const void *)(BS_UDBSWITCH_1_0_VAL),	/* TD 39 */
		(const void *)(BS_UDB_2_0_HV_ROUTING_VAL),	/* TD 40 */
		(const void *)(BS_UDB_2_1_HV_ROUTING_VAL),	/* TD 41 */
		(const void *)(BS_UDB_2_2_HV_ROUTING_VAL),	/* TD 42 */
		(const void *)(BS_UDB_1_3_HV_ROUTING_VAL),	/* TD 43 */
		(const void *)(BS_UDBSWITCH_1_3_VAL),	/* TD 44 */
		(const void *)(BS_UDB_2_3_HV_ROUTING_VAL),	/* TD 45 */
		(const void *)(BS_UDBSWITCH_1_4_VAL),	/* TD 46 */
		(const void *)(BS_UDB_2_4_HV_ROUTING_VAL),	/* TD 47 */
		(const void *)(BS_UDB_1_5_HV_ROUTING_VAL),	/* TD 48 */
		(const void *)(BS_UDBSWITCH_1_5_VAL),	/* TD 49 */
		(const void *)(BS_UDB_2_5_HV_ROUTING_VAL),	/* TD 50 */
		(const void *)(BS_DSI3_1_HV_ROUTING_VAL),	/* TD 51 */
		(const void *)(BS_DSISWITCH_1_2_VAL),	/* TD 52 */
		...
		(const void *)(BS_UCFG_BCTL1_VAL),	/* TD 58 */
		(const void *)(BS_UCFG_BCTL0_VAL),	/* TD 59 */
	};
