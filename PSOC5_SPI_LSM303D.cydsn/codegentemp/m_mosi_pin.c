...
{
    uint8 staticBits = (m_mosi_pin_DR & (uint8)(~m_mosi_pin_MASK));
    m_mosi_pin_DR = staticBits | ((uint8)(value << m_mosi_pin_SHIFT) & m_mosi_pin_MASK);
}
...
{
    return (m_mosi_pin_PS & m_mosi_pin_MASK) >> m_mosi_pin_SHIFT;
}
...
{
    return (m_mosi_pin_DR & m_mosi_pin_MASK) >> m_mosi_pin_SHIFT;
}
...
/* If Interrupts Are Enabled for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
        return (m_mosi_pin_INTSTAT & m_mosi_pin_MASK) >> m_mosi_pin_SHIFT;
    }
