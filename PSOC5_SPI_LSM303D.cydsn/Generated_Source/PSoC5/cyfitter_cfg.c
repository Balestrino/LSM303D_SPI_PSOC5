...
/* Size, Next, Flags, Source, Destination */
	...
	{ 3072, 0x0E, 0x22, (uint16)(0), (uint16)(CYDEV_UCFG_B0_P0_U0_BASE) },	/* TD 13 */
	{ 128, 0x0F, 0x22, (uint16)(0), (uint16)(CYDEV_UCFG_B0_P7_U1_BASE) },	/* TD 14 */
	{ 2048, 0x10, 0x22, (uint16)(0), (uint16)(CYDEV_UCFG_B1_P2_U0_BASE) },	/* TD 15 */
	{ 1024, 0x11, 0x22, (uint16)(0), (uint16)(CYDEV_UCFG_DSI0_BASE) },	/* TD 16 */
	{ 128, 0x12, 0x22, (uint16)(0), (uint16)(CYDEV_UCFG_DSI5_BASE) },	/* TD 17 */
	{ 1024, 0x13, 0x22, (uint16)(0), (uint16)(CYDEV_UCFG_DSI6_BASE) },	/* TD 18 */
	{ 512, 0xFF, 0x22, (uint16)(0), (uint16)(CYDEV_UCFG_DSI12_BASE) },	/* TD 19 */
	{ 32, 0xFF, 0x23, (uint16)(0), (uint16)(CYDEV_UWRK_UWRK8_B0_BASE + 0x00000070) },	/* TD 20 */
	...
	{ 128, 0x19, 0x23, (uint16)(0), (uint16)(CYDEV_UCFG_DSI5_BASE + 0x00000080) },	/* TD 24 */
	{ 128, 0x1A, 0x23, (uint16)(0), (uint16)(CYDEV_UCFG_DSI4_BASE) },	/* TD 25 */
	{ 128, 0x1B, 0x23, (uint16)(0), (uint16)(CYDEV_UCFG_DSI4_BASE + 0x00000080) },	/* TD 26 */
	{ 128, 0x1C, 0x23, (uint16)(0), (uint16)(CYDEV_UCFG_B0_P6_ROUTE_BASE) },	/* TD 27 */
	{ 128, 0x1D, 0x23, (uint16)(0), (uint16)(CYDEV_UCFG_B0_P6_ROUTE_BASE + 0x00000080) },	/* TD 28 */
	{ 128, 0x1E, 0x23, (uint16)(0), (uint16)(CYDEV_UCFG_B0_P7_ROUTE_BASE) },	/* TD 29 */
	{ 128, 0x1F, 0x23, (uint16)(0), (uint16)(CYDEV_UCFG_B0_P7_ROUTE_BASE + 0x00000080) },	/* TD 30 */
	{ 16, 0xFF, 0x23, (uint16)(0), (uint16)(CYREG_BCTL0_MDCLK_EN) },	/* TD 31 */
};
/* Source addresses can be relocated, but only when in 32bit addresses.
   Because the standard TD table only has 16bit addresses, we generate a
...
static const void * const CFG_TD_ADDR0[] = {
	...
	(const void *)(BS_DSI0_4_HV_ROUTING_VAL),	/* TD 24 */
	(const void *)(BS_DSISWITCH_0_5_VAL),	/* TD 25 */
	(const void *)(BS_DSI0_5_HV_ROUTING_VAL),	/* TD 26 */
	(const void *)(BS_UDBSWITCH_0_4_VAL),	/* TD 27 */
	(const void *)(BS_UDB_1_4_HV_ROUTING_VAL),	/* TD 28 */
	(const void *)(BS_UDBSWITCH_0_5_VAL),	/* TD 29 */
	(const void *)(BS_UDB_1_5_HV_ROUTING_VAL),	/* TD 30 */
...
static void cfg_dma_init(void)
{
	...
	CY_SET_REG16((reg16 *) &DMAC_TDMEM[0].TD0[0], 31*8);					/* set td0's size */
	...
	DMAC_CH[5].basic_status[1] = 0x14; /* First TD = 20 */
